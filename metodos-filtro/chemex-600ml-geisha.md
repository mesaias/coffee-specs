...
- **Temperatura**: 205°F (96°C)

## 🛠️ Equipamiento adicional
- [x] Filtro de papel Chemex (Enjuague profundo con agua caliente)
...
- *Reducir de 43g a 40g es vital. El Geisha es denso y en dosis altas colapsa el papel. 40g es el límite para mantener claridad aromática.*
- *El **Nivel 70** liberará el flujo respecto a niveles anteriores más bajos y eliminará el "efecto lodo".*
- *Para un perfil más ligero y floral (tipo té), puedes aumentar el ratio a 1:16 (40g café / 640ml agua) manteniendo el Nivel 70.*
