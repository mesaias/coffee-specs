...
**Estado:** ✅ EXITO (Validado el 01-01-2026)
**Resultado:** Extracción limpia, aromática y con claridad de sabor que resalta el origen del grano.
...
- **Molienda**: Media
- **Temperatura**: Variable según altitud (82°C a 1,000 msnm / 93°C a nivel del mar)

## 🛠️ Equipamiento adicional
- [x] Dripper V60
- [x] Filtro de papel para V60
- [x] Báscula (Precisión 0.1g)
- [x] Cronómetro
- [x] Tetera cuello de cisne (Gooseneck)
- [ ] Pulverizador de agua (RDT)

## 📝 Procedimiento
1. **Preparación del agua**: Calentar al menos 300ml de agua a la temperatura objetivo según tu altitud. Usar el excedente para precalentar utensilios.
2. **RDT y Molienda**: Pesar 18g de café. Aplicar 2-3 pulverizaciones de agua (RDT) para eliminar estática. Moler en ajuste medio.
...
- *La temperatura objetivo sigue la regla: T_ebullicion - 16°C.*
- *Usar cafés con 2 a 6 semanas de tueste para mejores resultados.*
- *Probar siempre la primera taza sola para apreciar la dulzura natural y acidez equilibrada.*
