...
**Estado:** ✅ Validada (Receta de Hatzel)
**Objetivo:** Extracción limpia, aromática y con claridad de sabor que resalta el origen del grano.
...
- [x] **Dripper**: V60
- [x] **Filtro**: Papel para V60
- [x] **Báscula**: Precisión 0.1g
- [x] **Cronómetro**: Esencial para los vertidos
- [x] **Kettle**: Cuello de cisne (Gooseneck) preferiblemente
- [x] **Accesorios**: Pulverizador de agua (RDT), Jug de cristal, Taza precalentada
...
2. **RDT y Molienda**: Pesar 18g de café. Aplicar **2-3 pulverizaciones de agua** (RDT) para eliminar estática. Moler en ajuste medio (~1,200 μm).
