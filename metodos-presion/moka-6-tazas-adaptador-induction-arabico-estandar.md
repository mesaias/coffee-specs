...
- **Inducción**: **Nivel 9 en Supra**

## 🛠️ Equipamiento adicional
- [x] Adaptador para inducción (Indispensable para aluminio)
- [x] Báscula de precisión
- [x] Tetera de cuello de cisne (Para control de llenado)
- [x] Cronómetro (Tiempo total objetivo: 4:00 min)
...
5. **Extracción**:
    - Iniciar en **Nivel 9 en Supra** para calentar el disco adaptador rápidamente.
    - En cuanto aparezca el primer flujo de café, bajar a **Nivel 7 en Supra**.
