...
- **Ratio**: ~1:5.8
- **Café**: 26g (Baja Desert Descafeinado)
- **Agua**: 150ml
- **Molienda**: Fina-Media / **Nivel 26** en DF54
- **Temperatura**: Agua al tiempo (Ambiente)
- **Inducción**: **Nivel 7 en Supra**
...
4. **Extracción**: Colocar en inducción a **Nivel 7 en Supra**. Mantener la tapa abierta para monitorear el flujo.
...
<img src="../assets/images/brikka-4-tazas-induction-baja-desert-descafeinado.jpg" width="350">
